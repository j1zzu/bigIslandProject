...
test('serves config, frontend and GeoJSON', async (t) => {
  ...
  assert.match(html, /id="create-layer-button"/);
  assert.match(html, /id="create-layer-backdrop"/);
  assert.match(html, /id="admin-editor-button"/);
  assert.match(html, /id="editor-backdrop"/);
  assert.match(html, /id="maps-layer-list"/);
  assert.match(html, /id="zones-layer-list"/);
  ...
  assert.doesNotMatch(html, /id="user-layers-list"/);
